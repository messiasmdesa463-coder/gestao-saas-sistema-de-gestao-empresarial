                  ...
                  <td colSpan={9} className="py-14 text-center">
                    <div className="flex flex-col items-center justify-center max-w-sm mx-auto">
                      ...
                      <p className="text-xs text-slate-500 mb-3 text-center">
                        Quando você registrar entradas, saídas ou ajustes nos produtos, o histórico completo aparecerá aqui.
                      </p>
                    </div>
                  </td>
                </tr>
              ...
              <div>
                ...
                {products.length === 0 ? (
                  <div className="p-3 bg-amber-50 text-amber-800 rounded-lg text-xs border border-amber-200">
                    Nenhum produto cadastrado no catálogo. Adicione produtos na aba "Produtos" antes de movimentar estoque.
                  </div>
                ) : (
                  <>
                    <select
