              ...
              {users.map(user => (
                <tr key={user.id} className="hover:bg-slate-50/80 transition-colors">
                  ...
                  <td className="py-3 px-4 text-right">
                    {(currentRole === 'admin' || (currentRole === 'dono' && user.perfil !== 'admin') || (currentRole === 'gerente' && user.perfil === 'funcionario')) && (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  {/* A opção de cadastrar GERENTE aparece para o Dono (e Admin), mas APENAS para Dono */}
                  {(currentRole === 'dono' || currentRole === 'admin') && (
                ...
                {currentRole === 'dono' && (
                  <p className="text-[11px] text-blue-600 mt-1.5 font-medium flex items-center gap-1">
                    <CheckCircle2 className="w-3.5 h-3.5" /> Como Dono da empresa, você tem autorização exclusiva para nomear e cadastrar Gerentes.
                  </p>
                )}
                {currentRole !== 'dono' && currentRole !== 'admin' && (
                  <p className="text-[11px] text-slate-500 mt-1.5">
                    * Apenas o Dono da empresa tem permissão para cadastrar colaboradores com o perfil Gerente.
                  </p>
                )}
              </div>
